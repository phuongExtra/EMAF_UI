<template>
  <app-header />
  <div class="el-div-main update-account">
    <el-col :span="16" class="update-account-inner">
      <div class="label">
      ...
      <el-row>
        ...
        <div class="info">
          ...
          <el-col :span="20">
            <div class="box-edit">
              <el-input v-model="txtPhoneNumber" />
            </div>
          </el-col>
        </div>
        ...
        <div class="info">
          ...
          <el-col :span="20">
            <div class="box-edit">
              <div class="input">
                <el-input v-model="txtPassword" />
                <p v-if="errors.password" class="fForm__error">
                  {{ errors.password }}
                </p>
              </div>
            </div>
        ...
        <div class="info group-button">
          ...
          <el-button class="btn-update" @click="handleNext"
...
export default {
  ...
  methods: {
    validate() {
      ...
      this.txtEmail === ""
        ? (this.errors.email = "Summary is required")
